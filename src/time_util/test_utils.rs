...
pub fn local_time_slot(hour_start: u32, minute_start: u32, second_start: u32, hour_end: u32, minute_end: u32, second_end: u32) -> ZonedSlot {
    ZonedSlot::Local((time(hour_start, minute_start, second_start)..time(hour_end, minute_end, second_end)).into())
}